...
echo $Tag_Version
export tmp=$(mktemp)
jq '."Tag_Version" = "'"$Tag_Version"'"' /home/$userName/projects/$DIRECTORY_REPO/EnvDags/$test_composer_environmentName/dags/$dag_config_name > "$tmp" && mv "$tmp" /home/$userName/projects/$DIRECTORY_REPO/$test_composer_environmentName/dags/$dag_config_name
jq '."artifact_registry" = "'"$artifact_registry"'"' /home/$userName/projects/$DIRECTORY_REPO/EnvDags/$test_composer_environmentName/dags/$dag_config_name > "$tmp" && mv "$tmp" /home/$userName/projects/$DIRECTORY_REPO/$test_composer_environmentName/dags/$dag_config_name
jq '."Dbt_project_Name" = "'"$Dbt_project_Name"'"' /home/$userName/projects/$DIRECTORY_REPO/EnvDags/$test_composer_environmentName/dags/$dag_config_name > "$tmp" && mv "$tmp" /home/$userName/projects/$DIRECTORY_REPO/$test_composer_environmentName/dags/$dag_config_name
gsutil cp /home/$userName/projects/$DIRECTORY_REPO/EnvDags/$test_composer_environmentName/dags/$dag_config_name gs://$gcs_composer/dags/
